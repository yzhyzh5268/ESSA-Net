...
def parse_args():
    ...
    parser.add_argument('--in_xml_vi_dir', default=r'D:\TwoStream_Yolov8-main\datasets\labels\test', help='可见光 XML 文件地址')
    parser.add_argument('--in_xml_ir_dir', default=r'D:\TwoStream_Yolov8-main\datasets\labels\test', help='红外光 XML 文件地址')
    parser.add_argument('--out_vi_txt_dir', default=r'D:\TwoStream_Yolov8-main\datasets\labels\test_vi', help='可见光 TXT 文件地址')
    parser.add_argument('--out_ir_txt_dir', default=r'D:\TwoStream_Yolov8-main\datasets\labels\test_ri', help='红外光 TXT 文件地址')
    parser.add_argument('--in_vi_img_dir', default=r'D:\TwoStream_Yolov8-main\datasets\image\test', help='裁切后的 vi-img 地址')
    parser.add_argument('--in_ir_img_dir', default=r'D:\TwoStream_Yolov8-main\datasets\images\test', help='裁切后的 ir-img 地址')
