...
class Exporter:
    ...
    def __call__(self, model=None) -> str:
        ...
        # Input
        im = torch.zeros(self.args.batch, 6, *self.imgsz).to(self.device)
        file = Path(
        ...
        # if self.args.half and engine  and self.device.type != "cpu":
        #     im, model = im.half(), model.half()  # to FP16
    ...
    def get_int8_calibration_dataloader(self, prefix=""):
        ...
        dataset = YOLODataset(
            ...
            imgir_path=data[self.args.split or "val"].replace("images", "image")  ,
